			...
			<div className="max-w-4xl mx-auto flex justify-between items-center p-4">
				...
				<ul className="flex space-x-8 text-gray-700">
					...
					<div className="relative">
						...
						<div className="fixed top-3 right-10 text-xl font-semibold duration-100 dark:bg-slate-100 rounded">

							{
								options?.map(opt=>(
									...
									className={`w-8 h-8 leading-9 text-xl rounded-full m-1 ${theme === opt.text && "text-sky-400"}`}
									>
